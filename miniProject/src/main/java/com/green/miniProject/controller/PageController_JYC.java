...
public class PageController_JYC {
	...
	@GetMapping("/company")
	public String company(@RequestParam("page") Long page, @RequestParam("keyword") String keyword, Model model,
			@RequestParam("encurrentpage") Long encurrentpage, @RequestParam("memcurrentpage") Long memcurrentpage) {
		String str;
	...
	@GetMapping("/member")
	public String member(@RequestParam("page") Long page, @RequestParam("keyword") String keyword, Model model,
			@RequestParam("comcurrentpage") Long comcurrentpage, @RequestParam("encurrentpage") Long encurrentpage) {
	...
	public String employnotice(@RequestParam("page") Long page, @RequestParam("keyword") String keyword, Model model,
			@RequestParam("memcurrentpage") Long memcurrentpage, @RequestParam("comcurrentpage") Long comcurrentpage) {
